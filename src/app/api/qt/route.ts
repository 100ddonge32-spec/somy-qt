    ...
    try {
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: 'system',
                    content: `당신은 탁월한 성경 해석가이자 큐티 전문가입니다. 요청받은 성경 구절을 바탕으로 성도들이 깊이 있게 묵상할 수 있는 콘텐츠를 생성하세요.

[필수 작성 항목]
1. 실제 범위: 요청받은 기점에서 묵상하기 좋은 정확한 장:절 범위를 판단하세요. (예: "민수기 3:1-13")
2. 성경 본문: 한국어 '개역한글' 버전의 성경 본문을 절 번호와 함께 토씨 하나 틀리지 않고 그대로 적어주세요. 절대 요약하지 마세요.
3. 본문 해설: 본문의 영적 배경과 깊은 뜻을 3~4문장의 따뜻한 문체로 해설하세요.
4. 묵상 질문 3개: 삶에 적용할 수 있는 질문
